...
> **Note:** Occasional UE crashes **may** still occur due to simulator instability, but in the **majority** of iterations, the UE should start and stop normally without crashing.
...
**What this demonstrates:** The contrast between Step 1 (baseline, no crash) and Step 2 (exploit loaded, frequent crashes) confirms that the **constraint-violating payloads generated by E1 can reliably trigger UE crashes** during OTA-style replay.
