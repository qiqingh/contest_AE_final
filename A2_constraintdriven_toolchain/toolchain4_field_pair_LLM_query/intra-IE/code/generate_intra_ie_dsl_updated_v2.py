...
Updated to align with Inter-IE format (using field1/field2 in DSL)
"""
...
ASN_DIR = "../TS38331ASN"
OUTPUT_DIR = "../outputs/intra-IE_DSL_results_gpt4o"  # ⭐ New Directory
DIAGNOSIS_FILE = "../diagnosis/intra_ie_diagnosis_gpt4o.txt"  # ⭐ New Diagnostic File

# Evidence Sampling Configuration
MAX_EVIDENCES_PER_PAIR = 12
EVIDENCE_SAMPLE_STRATEGY = "smart"
...
# ============================================================================
# Prompt template - minor adjustment: require using field1/field2
# ============================================================================
...
def save_dsl_file(ie_name, field1, field2, field_ids, api_response, evidences, all_citations, original_evidence_count=None):
    ...
    try:
        ...
        if api_response and api_response.get("result") == "DSL":
            content = {
                "dsl_rule": api_response.get("dsl"),  # ⭐ Using field1/field2
                "constraint_type": api_response.get("type"),
                "has_valid_rule": True,
                "field_ids": formatted_field_ids,  # ⭐ Inter-IE Format
                ...
                "meta": {
                    ...
                    "field1": field1,
                    "field2": field2,
                    "is_intra_ie": True,  # ⭐ Marked as Intra-IE
...
def main():
    """main function"""
    print("="*60)
    print("🎯 INTRA-IE DSL GENERATION (Aligned with Inter-IE)")
