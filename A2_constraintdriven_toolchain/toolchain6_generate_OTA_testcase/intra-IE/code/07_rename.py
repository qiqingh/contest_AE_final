...
def batch_rename(directory_path):
    """
    Traverse all files in the specified directory and remove the '_reconstructed_offset' portion from the filenames
    ...
    print(f"Starting to process directory: {dir_path.absolute()}")
    print("-" * 50)
