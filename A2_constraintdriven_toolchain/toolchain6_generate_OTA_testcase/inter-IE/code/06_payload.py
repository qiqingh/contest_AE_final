...
# Ensure that the output directory and diagnostic directory exist
os.makedirs(output_dir, exist_ok=True)
os.makedirs(diagnosis_dir, exist_ok=True)

# Initialize diagnostic log
def log_message(message, also_print=True):
    """Write information to diagnostic logs, with optional printing to console"""
...
def read_modifications(file_path):
    """Read modifications file and parse offset and new value"""
    modifications = []
