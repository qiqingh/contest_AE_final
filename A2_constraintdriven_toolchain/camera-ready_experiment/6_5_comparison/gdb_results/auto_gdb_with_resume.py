...
PAYLOAD_DIR = "/home/qiqingh/Desktop/contest_AE_battle/A2_constraintdriven_toolchain/camera-ready_experiment/6_5_comparison/field_iterate/output/compiled_single_field_iterate"

# 进程信息
MAX_RUNS = 1  # 限制最多自动捕获 UE 崩溃的次数
