...
# 容器配置
CONTAINER_ID = "a13c7c71460e"
PAYLOAD_DIR = "/home/qiqingh/Desktop/usenix_security_revision_prepare/revision_experiments/compiled_our_approach"

# 进程信息
MAX_RUNS = 3  # 限制最多自动捕获 UE 崩溃的次数
GDB_TIMEOUT = 10  # GDB 运行时间（秒）
